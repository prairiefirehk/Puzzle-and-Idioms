    ...
    public class StatusEffect 
        {
            ...
            private EntityStat _affectedStat;
            public EntityStat affectedStat { get { return _affectedStat; } set { _affectedStat = value; } }


            public StatusEffect(StatusEffectType effectType, int effectTurns, int effectLevel, float effectValue, Entity effectTarget, EntityStat affectedStat)
            {
